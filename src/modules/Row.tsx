...
export class Row extends Component<IRowProps> {
    ...
    shouldComponentUpdate(nextProps: any) {
        if (this.props.item?.highestBid !== nextProps?.item?.highestBid) {
            ...
            return true;
        } else if (this.props.item?.percentChange !== nextProps?.item?.percentChange) {
    ...
    render() {
        ...
        return (
            <View style={styles.main}>
                ...
                <Animated.Text style={[styles.column, styles.value, { opacity: fadeAnimBid }]}>{item?.highestBid}</Animated.Text>
                <Animated.Text style={[styles.column, styles.value, { opacity: fadeAnimLast }]}>{item?.last}</Animated.Text>
                <Animated.Text style={[styles.column, styles.value, { opacity: fadeAnimPercent }]}>{item?.percentChange}</Animated.Text>
            </View>
        );
    }
}
